...
--]]
--[[
detection_name: SSL Group "344"
version: 5
description: Group of SSL Host detectors.
bundle_description: $VAR1 = {
          'ZenMate' => 'Proxy and security add-on to browser.',
          'Yelp' => 'Social networking, user review, and local search service.',
...
gSSLHostPatternList = {
    ...
    {0, 938, 'yelp.com', },
    -- ZenMate
    {1, 3994, 'nodes.gen4.ninja', },
    {1, 3994, 'mate.zone', },
    -- CloudFlare
    {0, 2535, 'cloudflare.net', },
    {0, 2535, 'cloudflareinsights.com', },
    {0, 2535, 'cloudflaressl.com', },
}
