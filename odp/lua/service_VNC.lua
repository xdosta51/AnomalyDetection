...
--]]
--[[
detection_name: VMware Remote Authentication
version: 4
description: VMware Daemon for authentication of remote VMs.
bundle_description: $VAR1 = {
          'Apple Remote Desktop' => 'VNC on Mac OSX.',
          'VMware Remote Authentication' => 'VMware Daemon for authentication of remote VMs.'
        };
...
gServiceId = 24
gServiceName = 'VMware Remote Authentication'
gDetector = nil

DetectorPackageInfo = {
    name =  "VMware Remote Authentication",
