...
detection_name: AOL
version: 6
description: American company develops, grows and invests in brands and web sites.
...
function DetectorInit(detectorInstance)
    ...
    if (gDetector.CHPMultiCreateApp and gDetector.CHPMultiAddAction) then
        local handle = gDetector:CHPMultiCreateApp(1419, 4, 0);
        gDetector:CHPMultiAddAction(handle, 1, 1, "search.aol.com", 14, "");
